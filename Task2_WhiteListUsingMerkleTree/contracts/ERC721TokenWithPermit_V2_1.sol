 ...
 * @author Garen Woo
 */
contract ERC721TokenWithPermit_V2_1 is ERC721URIStorage, EIP712, Nonces, NFTMarket_Standard_Interface_V2 {
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override returns (bool) {
        return
            _interfaceId == type(NFTMarket_Standard_Interface_V2).interfaceId || super.supportsInterface(_interfaceId);
    }
